...
public class PowerupWalkFreeze extends StaticEntity {
    private List<PowerupListener> listeners = new ArrayList<PowerupListener>();
    private boolean pickedUp;

    public PowerupWalkFreeze(Vector2 pos, Vector2 size) {
        super(pos, size, TextureLoader.getInstance().getTextureForType(GameState.EntityType.POWERUP_WALK_FREEZE));
        this.pickedUp = false;
    }
    ...
    protected void notifyPowerupListeners (PowerupWalkFreeze powerup) {
